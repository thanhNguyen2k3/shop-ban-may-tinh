    <footer style="border-top: 3px solid var(--primary);">
        <section>
            <div class="footer">
                <div class="footer-manual">
                    ...
                    <div class="footer-nav">
                        <h4 class="footer-title">Chính sách Mua hàng và Bảo hành</h4>
                        <ul class="footer-list">
                    ...
                    <div class="footer-nav">
                        <h4 class="footer-title">Email liên hệ</h4>
                        <ul class="footer-list">
                            <li>Hỗ trợ Khách hàng:</li>
                            <li><a href="" class="email">thanhs2fo4@gmail.com</a></li>
                            <li>Liên hệ báo giá:</li>
                            <li><a href="" class="email">thanhlh@gmail.com</a></li>
                            <li>Hợp tác phát triển:</li>
                            <li><a href="" class="email">thanhht@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="pay-method">
                    <div class="pay-line">
                        <div class="pay-pack">
                            <h3 class="pay-title">Phương thức thanh toán</h3>
                            <span class="pay-icon">
            ...
            <div style="background-color:#e9edf2;">
                <div class="footer-end">
                    <div style="margin-right: 60px;">
                        <h3 class="end-title">Công ty cổ phần thương mại - dịch vụ Phong Vũ</h3>
                        <p class="note-history">© 1997 - 2020 Công Ty Cổ Phần Thương Mại - Dịch Vụ Phong Vũ Giấy
                    ...
                    <div>
                        <h4 class="end-address">Địa chỉ trụ sở chính:</h4>
                        <p class="note-history">Tầng 5, Số 117-119-121 Nguyễn Du, Phường Bến Thành, Quận 1, Thành Phố Hồ Chí Minh</p>

                        <h4 class="end-address">Văn phòng điều hành miền Bắc:</h4>
                        <p class="note-history">Tầng 6, Số 1 Phố Thái Hà, Phường Trung Liệt, Quận Đống Đa, Hà Nội</p>

                        <h4 class="end-address">Văn phòng điều hành miền Nam:</h4>
                        <p class="note-history">Tầng 11 Minh Long Tower, số 17 Bà Huyện Thanh Quan, Phường Võ Thị Sáu, Quận 3, TP. Hồ Chí Minh</p>
                    </div>
                </div>
            </div>
        </section>
